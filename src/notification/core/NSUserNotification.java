...
import notification.libraries.NSUserNotificationCInterface;
...
public class NSUserNotification {
  ...
  public NSUserNotification() {
    if (library == null) {
      ...
      library = (NSUserNotificationCInterface) Native
          .loadLibrary("OSXNotification", NSUserNotificationCInterface.class);
    }
  ...
  public void setDeliveryRepeatInterval(int seconds) {
    ...
    if (seconds >= 60) {
      library.NSUserNotificationSetDeliveryRepeatInterval(this.notification, seconds);
    }
  }
